...
class football:
    ...
    def test_collect_data(self,url):
        """
    ...
    def test_save(self):
        ...
        plt.savefig('C:/Users/Tchouanga/OneDrive - aivancity/Documents/GitHub/Advanced_analysis/FinalProject/visualize/visualize.jpg',bbox_inches="tight", dpi = 80)
        plt.close()
        return r'C:/Users/Tchouanga/OneDrive - aivancity/Documents/GitHub/Advanced_analysis/FinalProject/visualize/visualize.jpg'


    def test_visualize_command(self,command):
        """
